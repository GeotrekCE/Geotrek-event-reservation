  ...
  <main class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8 px-4 py-6">
    ...
    <div v-else-if="success" class="space-y-6">
      ...
      <template v-if="!listeAttente">
        <p>
          Votre réservation a été <strong>acceptée</strong>, vous allez recevoir
      ...
      <template v-else>
        <p>
          ...
          <strong>liste d'attente</strong>, il n'y a plus assez de place pour
          cet événement.
        </p>
        <p>
          Dans le cas où des places venaient à se libérer, vous serez informé
          par email ou contacté par le parc directement.
        </p>
      </template>
    </div>
    <div v-else class="space-y-6">
      ...
      <p>
        Vous pouvez essayer de recharger cette page pour tenter une nouvelle
        confirmation, ou vous pouvez prendre contact avec nous pour confirmer
        manuellement votre réservation.
      </p>
