    ...
    <main class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <ul class="list-disc ml-10">
          <li>
            Nombre d'évènements : {{ stats.nb_animations }}
          </li>
          <li>
            Nombre d'évènements annulées : {{ stats.nb_annulation }}
          </li>
          <li>
            Nombre d'évènements avec réservation : {{ stats.nb_animations_capacity }}
          </li>
          <li>
            Capacité d'accueil : {{ stats.sum_animations_capacity }}
          </li>
          <li>
            Nombre d'inscrits : {{ stats.sum_nb_inscriptions }}
          </li>
          <li>
            Taux de remplissage global (Total inscrits / Total places) : {{ stats.taux_remplissage_global }}
          </li>
          <li>
            Taux de remplissage moyen (Moyenne des taux des animations) : {{ stats.taux_remplissage_moyen }}
          </li>
        </ul>
        ...
        <ul class="list-disc ml-10">
          <li>
            Nombre d'évènements : {{ stats.nb_animations_passe }}
          </li>
          <li>
            Nombre d'évènements annulées : {{ stats.nb_annulation_passe }}
          </li>
          <li>
            Nombre d'évènements avec réservation : {{ stats.nb_animations_capacity_passe }}
          </li>
          <li>
            Capacité d'accueil : {{ stats.sum_animations_capacity_passe }}
          </li>
          <li>
            Nombre d'inscrits : {{ stats.sum_nb_inscriptions_passe }}
          </li>
          <li>
            Taux de remplissage global (Total inscrits / Total places) : {{ stats.taux_remplissage_global_passe }}
          </li>
          <li>
            Taux de remplissage moyen (Moyenne des taux des animations) : {{ stats.taux_remplissage_moyen_passe }}
          </li>
        </ul>
        </div>
