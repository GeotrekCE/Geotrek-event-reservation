    ...
    <main class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section class="mt-10" v-if="!loading">
        ...
        <ul class="list-disc ml-10">
          <li>Nombre animations total : {{ stats.nb_animations }}</li>
          <li>Nombre animations annulées : {{ stats.nb_annulation }}</li>
          <li>Taux de remplissage : {{ stats.taux_remplissage }}</li>
          <li>
            Taux de remplissage des animations passées:
            {{ stats.taux_remplissage_passe }}
          </li>
        </ul>
