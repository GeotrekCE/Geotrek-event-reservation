...
export const putEventInfo = (id: any, data: Partial<ResaEventInfo>): Promise<ResaEventInfo> =>
...
export const sendEmailCancellation = (id: number) =>
  postApiData(CONFIGURATION.URL_APPLICATION, `events/${id}/cancel-reservations`)
